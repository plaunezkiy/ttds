    ...
    def calculate_MI(self):
        ...
        for corpus in self.corpora:
            ...
            for term in term_counts[corpus]:
                # Get counts for MI calculation
                n11 = term_counts[corpus].get(term, 0)  # term occurs in this corpus
                n1_ = sum(counts.get(term, 0) for counts in term_counts.values())  # term occurs in all corpora
                n_1 = corpus_sizes[corpus]  # total docs in this corpus
